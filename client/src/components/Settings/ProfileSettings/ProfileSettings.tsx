...
export function ProfileSettings(): JSX.Element {
    const { user } = useAuth();
    const { user_info, refresh_user_info, setUserInfo } = useUserInfo(
        user!._id
    );
    ...
    const [profile_image, serProfileImage] = useState<File | null>(
        user_info.image_path ? user_info.image : null
    );
    ...
    const handleChangeClick = async (): Promise<void> => {
        ...
        if (username_regexp.test(usrnm)) {
            ...
            try {
                const image_url: string | undefined = await uploadProfileImage(
                    profile_image
                );
    ...
    const handlePhotoClick = () => {
        const uploader: HTMLInputElement | null =
        ...
        <div className="left-container profile-settings-container">
            <div className="new-group-chat-info">
                ...
                <div className="profile-settings-username">
                    ...
                    <p className="profile-settings-footer">
                        You can choose a username on <b>Mintgram.</b>
                        <br />
